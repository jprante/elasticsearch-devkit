...
import org.xbib.randomizedtesting.junit5.provider.NumericArgumentProvider;
...
/**
 * Can pass a random string containing only digits to a JUnit5 test.
...
@Repeatable(Numerics.class)
@ArgumentsSource(NumericArgumentProvider.class)
@ParameterizedTest
