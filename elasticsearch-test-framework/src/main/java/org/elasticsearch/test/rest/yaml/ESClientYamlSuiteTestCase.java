...
import org.elasticsearch.common.io.ResourceUtilsForTesting;
...
public abstract class ESClientYamlSuiteTestCase extends ESRestTestCase {
    ...
    static Map<String, Collection<URL>> loadSuites(ClassLoader classLoader, String... paths) throws Exception {
        return ResourceUtilsForTesting.getResourceGroups(classLoader,
                TESTS_PATH, Arrays.asList(paths));
    }
