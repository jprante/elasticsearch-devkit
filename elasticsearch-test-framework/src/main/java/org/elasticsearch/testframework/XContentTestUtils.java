...
import org.elasticsearch.testframework.rest.yaml.ObjectPath;
...
public final class XContentTestUtils {
     ...
     * </ul>
     */
    public static List<String> getInsertPaths(XContentParser parser, Stack<String> currentPath) throws IOException {
