...
import static org.apache.lucene.testframework.util.LuceneTestCase.assumeTrue;
        ...
        try (Directory dir = FSDirectory.open(fileToCorrupt.toAbsolutePath().getParent())) {
            ...
            try (FileChannel raf = FileChannel.open(fileToCorrupt, StandardOpenOption.READ, StandardOpenOption.WRITE)) {
                ...
                logger.info("Corrupting file --  flipping at position {} from {} to {} file: {}",
                        filePointer, Integer.toHexString(oldValue), Integer.toHexString(newValue), fileToCorrupt.getFileName());
            }
