...
/**
 * This is a testing plugin that registers a generic {@link org.elasticsearch.testframework.MockIndexEventListener.TestEventListener}
 * as a node level service as well as a listener
