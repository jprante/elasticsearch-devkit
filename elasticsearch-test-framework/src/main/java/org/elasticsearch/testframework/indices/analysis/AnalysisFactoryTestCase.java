package org.elasticsearch.testframework.indices.analysis;
...
public abstract class AnalysisFactoryTestCase extends ESTestCase {
    ...
    static final Map<String,Class<?>> KNOWN_TOKENFILTERS = new MapBuilder<String,Class<?>>()
        ...
        .put("deduplicating",             MovedToAnalysisCommon.class)
    ...
    public void testTokenFilters() {
        Set<String> missing = new TreeSet<>(org.apache.lucene.analysis.util.TokenFilterFactory.availableTokenFilters());
