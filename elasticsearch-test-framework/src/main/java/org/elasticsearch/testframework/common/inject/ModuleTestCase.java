package org.elasticsearch.testframework.common.inject;
...
public abstract class ModuleTestCase extends ESTestCase {
     ...
     */
    public <T> void assertInstanceBindingWithAnnotation(Module module, Class<T> to, Predicate<T> tester,
    ...
    public <K, V> void assertMapInstanceBinding(Module module, Class<K> keyType, Class<V> valueType, Map<K, V> expected) {
