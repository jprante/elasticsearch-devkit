...
public abstract class AbstractQueryTestCase<QB extends AbstractQueryBuilder<QB>> extends ESTestCase {
    ...
    private static TestSearchContext getSearchContext(String[] types, QueryShardContext context) {
     ...
     */
    public static List<Tuple<String, Boolean>> alterateQueries(Set<String> queries, Set<String> arbitraryMarkers) throws IOException {
    ...
    public void testToQuery() throws IOException {
        for (int runs = 0; runs < NUMBER_OF_TESTQUERIES; runs++) {
            ...
            TestSearchContext searchContext = getSearchContext(randomTypes, context);
