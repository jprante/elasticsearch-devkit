...
class VagrantPlugin implements Plugin<Project> {
    ...
    private static void createVagrantBoxesTasks(Project project) {
        ...
        for (String box : BOXES) {
            ...
            VagrantCommandTask halt = project.tasks.create("vagrant${boxTask}#halt", VagrantCommandTask) {
                command 'halt'
                boxName box
            ...
            VagrantCommandTask update = project.tasks.create("vagrant${boxTask}#update", VagrantCommandTask) {
                command 'box'
                subcommand 'update'
                boxName box
                environmentVars vagrantEnvVars
            ...
            VagrantCommandTask up = project.tasks.create("vagrant${boxTask}#up", VagrantCommandTask) {
                command 'up'
                boxName box
                environmentVars vagrantEnvVars
            ...
            BatsOverVagrantTask packaging = project.tasks.create("vagrant${boxTask}#packagingTest", BatsOverVagrantTask) {
            ...
            VagrantCommandTask platform = project.tasks.create("vagrant${boxTask}#platformTest", VagrantCommandTask) {
                command 'ssh'
                boxName box
                environmentVars vagrantEnvVars
                dependsOn up
