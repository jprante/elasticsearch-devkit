...
class RestTestsFromSnippetsTask extends SnippetsTask {
    ...
    private class TestBuilder {
        ...
        private void test(SnippetsTask.Snippet test) {
            setupCurrent(test)
        ...
        private void response(SnippetsTask.Snippet response) {
        ...
        void emitDo(String method, String pathAndQuery, String body,
             ...
             */
            if (!inSetup && !path.startsWith('_cat')) {
                current.println("  - is_false: _shards.failures")
            }
        }

        private void setup(SnippetsTask.Snippet setup) {
        ...
        private void body(SnippetsTask.Snippet snippet, boolean inSetup) {
        ...
        private PrintWriter setupCurrent(SnippetsTask.Snippet test) {
        ...
        void checkUnconverted() {
            ...
            for (String listed : expectedUnconvertedCandidates) {
                if (!unconvertedCandidates.remove(listed)) {
                    listedButNotFound.add(listed)
                }
            }
            String message = ""
            if (!listedButNotFound.isEmpty()) {
            ...
            if (!unconvertedCandidates.isEmpty()) {
